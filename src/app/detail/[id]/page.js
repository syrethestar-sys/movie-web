...
export default function Detail() {
  ...
  const findMovie = data.find((item) => String(item.id) === String(id));
    ...
    <div className="flex flex-col items-center min-h-screen relative">
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[#71717A] text-xs">37k</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="relative w-full flex-1 h-[430px] rounded-xl overflow-hidden bg-black flex items-center justify-center">
            ...
            <div className="absolute z-10 left-6 bottom-6 flex items-center gap-3 text-white">
              ...
              <span className="text-gray-300 text-sm">2:35</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-8 animate-in fade-in duration-200">
          ...
          <div className="relative w-full max-w-5xl aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/10">
            ...
            <button
              ...
              className="absolute top-12 right-4 bg-black/70 hover:bg-black text-white px-3 py-1.5 text-xs rounded-full z-50 cursor-pointer border border-white/20 transition-all flex items-center gap-1"
            >
              ✕ Хаах
            </button>
      ...
      <div className="max-w-6xl w-full px-4 flex flex-col gap-5 mb-8">
        <div className="flex flex-wrap gap-2">
          {["Animated Film", "Musical", "Fantasy", "Adventure", "Family"].map(
            (genre, index) => (
              <span
                key={index}
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-12 pb-3 border-b border-[#E4E4E7]">
            ...
            <p className="text-base font-light">David G. Derrick Jr</p>
          </div>
          <div className="flex gap-12 pb-3 border-b border-[#E4E4E7]">
          ...
          <div className="flex gap-12 pb-3 border-b border-[#E4E4E7]">
            ...
            <p className="text-base font-light">
              Auli&apos;i Cravalho · Dwayne Johnson · Hualālai Chung
            </p>
          </div>
        </div>
      </div>
